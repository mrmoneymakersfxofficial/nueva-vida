...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: "content", title: "Contenido", type: "array", of: [{ type: "block" }], initialValue: [
      { _type: "block", _key: "g1", children: [{ _type: "span", _key: "s1", text: "Bienvenido al CMS de Nueva Vida." }], style: "h2" },
      { _type: "block", _key: "g2", children: [{ _type: "span", _key: "s2", text: "Usa el panel izquierdo para navegar entre secciones del sitio médico." }], style: "normal" },
