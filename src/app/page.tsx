...
import { Phone, Calendar, Shield, Heart, Baby, Stethoscope, ArrowRight, Star, CheckCircle2 } from 'lucide-react'
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white leading-tight">
                  Cuidamos tu{' '}
                  <span className="text-cyan-light">Nueva Vida</span>
                </h1>
                <p className="text-lg sm:text-xl text-white/80 max-w-lg leading-relaxed">
                  Atención médica especializada con tecnología de última generación. 
                  Tu salud y bienestar están en las mejores manos.
                </p>
              </motion.div>
                ...
                <div className="relative rounded-3xl overflow-hidden glass p-1">
                  <div className="rounded-2xl overflow-hidden">
                    <Image
                      ...
                      alt="Dr. Adolfo - Especialista en Ginecología"
                      width={400}
                      height={550}
                      className="object-cover"
                    />
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-marine/90 to-transparent">
                    <h3 className="text-white font-bold text-xl">Dr. Adolfo</h3>
                    <p className="text-cyan-light text-sm">Especialista en Ginecología y Obstetricia</p>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              <div className="relative">
                ...
                <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt="Interior del Consultorio Nueva Vida"
                    width={600}
                    height={400}
                ...
                {/* Floating badge */}
                <motion.div
                  className="absolute -bottom-6 -right-6 bg-cyan text-white rounded-2xl p-4 shadow-xl"
                  animate={{ y: [0, -8, 0] }}
                  transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}
                >
                  <div className="text-center">
                    <div className="text-3xl font-bold">15+</div>
                    <div className="text-xs opacity-80">Años</div>
                  </div>
                </motion.div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="right" delay={0.2}>
              <div className="space-y-6">
                <div>
                  ...
                  <h2 className="text-3xl sm:text-4xl font-bold text-marine mt-2 leading-tight">
                    Tu bienestar, nuestra{' '}
                    <span className="gradient-text">misión principal</span>
                  </h2>
                </div>
                <p className="text-marine/70 text-lg leading-relaxed">
                  En <strong className="text-marine">Nueva Vida</strong>, contamos con más de 15 años de experiencia 
                  brindando atención ginecológica integral de la más alta calidad. Nuestro consultorio está equipado 
                  con tecnología de última generación para garantizar diagnósticos precisos y tratamientos efectivos.
                </p>
                <p className="text-marine/60 leading-relaxed">
                  El Dr. Adolfo, especialista en Ginecología y Obstetricia, lidera un equipo comprometido con la 
                  salud femenina. Ofrecemos un ambiente cálido y profesional donde cada paciente recibe atención 
                ...
                <div className="grid grid-cols-2 gap-4 pt-4">
                  {[
                    ...
                    <div key={item} className="flex items-center gap-2 text-marine/80 text-sm">
                ...
                <div className="pt-4">
                  <MagneticButton href="/salud" strength={0.15}>
                    <Button variant="outline" className="border-royal text-royal hover:bg-royal hover:text-white rounded-full px-6 transition-all duration-300">
          ...
          <ScrollReveal>
            <div className="text-center max-w-2xl mx-auto mb-10 lg:mb-14">
              ...
              <p className="text-marine/60 mt-4 text-lg">
                Ofrecemos un amplio abanico de servicios ginecológicos con la más alta tecnología médica.
              </p>
            </div>
          </ScrollReveal>
                ...
                <Card className="border-0 shadow-lg shadow-marine/5 bg-gradient-to-b from-white to-muted/50 h-full">
                  <CardContent className="p-8 space-y-4">
                    ...
                    <div className="flex items-center gap-3 pt-2">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-cyan to-royal flex items-center justify-center">
                        <span className="text-white font-bold text-sm">{t.name.charAt(0)}</span>
                      </div>
                      <div>
                        <p className="font-semibold text-marine text-sm">{t.name}</p>
                        <p className="text-marine/50 text-xs">Paciente verificada</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight">
              ¿Lista para cuidar de tu salud?
            </h2>
            <p className="text-white/80 mt-6 text-lg max-w-2xl mx-auto leading-relaxed">
              Agenda tu cita de manera rápida y sencilla. Nuestro equipo está listo para brindarte 
              la atención que mereces con la calidez y profesionalismo que nos caracteriza.
            </p>
            <div className="flex flex-wrap gap-4 justify-center mt-10">
              <MagneticButton href="/reservas" strength={0.2}>
                <Button size="lg" className="bg-white text-marine hover:bg-white/90 font-semibold rounded-full px-10 h-14 text-base shadow-2xl transition-all duration-300">
                  <Calendar className="w-5 h-5 mr-2" />
                  Agendar Cita Ahora
                </Button>
              </MagneticButton>
