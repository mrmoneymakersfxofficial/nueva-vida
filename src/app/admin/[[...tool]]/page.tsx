...
const Studio = dynamic(() => import("next-sanity/studio").then((mod) => mod.NextStudio), { ssr: false, loading: () => <div style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh", background: "#0A2F6B" }}><p style={{ color: "#00A3E0", fontSize: 18, fontFamily: "sans-serif" }}>Cargando Studio...</p></div> });
...
function StudioGuard({ children }: { children: React.ReactNode }) {
  ...
  if (!hasProjectId) {
    return (
      <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", minHeight: "100vh", background: "#0A2F6B", padding: 32, textAlign: "center", fontFamily: "system-ui, sans-serif" }}>
