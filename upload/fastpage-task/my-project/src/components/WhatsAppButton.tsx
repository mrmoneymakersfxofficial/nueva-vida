...
export default function WhatsAppButton() {
  return (
    ...
    >
      {/* BUTTON — Official WhatsApp SVG */}
      <div className="relative">
        <div
          className="w-[60px] h-[60px] rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300"
          style={{
            backgroundColor: '#25D366',
            boxShadow: '0 4px 18px rgba(37, 211, 102, 0.45), 0 2px 6px rgba(0, 0, 0, 0.15)',
          }}
        >
          <svg
